...
// Explanation: The reason why nestedFunction() can access the variable internal is because nestedFunction is reaching outside of it's own scope and to grab the variable internal.
...
zooAnimals.forEach(function(item) {
  return nameTags.push(`Name: ${item.animal_name}, Scientific: ${item.scientific_name}`)
})
...
let USApop = zooAnimals.reduce(function(accumulator, item) {
